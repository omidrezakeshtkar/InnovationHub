			...
			<div className="max-w-4xl mx-auto">
				...
				<section className="mb-12">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						<div className="flex items-start">
							<Lightbulb className="mr-4" size={24} style={{color: primaryColor}} />
							<div>
						...
						<div className="flex items-start">
							<Users className="mr-4" size={24} style={{color: primaryColor}} />
							<div>
						...
						<div className="flex items-start">
							<Lock className="mr-4" size={24} style={{color: primaryColor}} />
							<div>
				...
				<section>
					...
					<div className="text-center">
						<button className="text-white px-8 py-3 rounded-md text-lg font-semibold transition duration-300" style={{backgroundColor: primaryColor, ':hover': {filter: 'brightness(90%)'}}}>
							Start Sharing Ideas
						</button>
					</div>
				</section>
