					...
					<div>
						...
						<form className="flex flex-col sm:flex-row">
							<input
								...
								className="bg-gray-700 text-white px-2 py-1 rounded-t-md sm:rounded-l-md sm:rounded-t-none focus:outline-none focus:ring-2 focus:ring-{primaryColor} focus:ring-opacity-50"
							/>
							<button
								type="submit"
